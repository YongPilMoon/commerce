...
const sneakers = [
  {
    ...
    contents: `{"blocks":[{"key":"65s42","text":"NEW Mens Rivers Classic Sneaker | Athletic Footwear Shoes","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":0,"length":21,"style":"color-rgb(0,0,0)"},{"offset":0,"length":21,"style":"fontsize-medium"},{"offset":0,"length":21,"style":"fontfamily-ui-sans-serif, system-ui, -apple-system, 'system-ui', 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'"}],"entityRanges":[],"data":{}}], "entityMap":{}}`,
    category_id: 1,
